...
var content = ["a Software Engineering student.    ", "a Developer.    "];
		...
		return (
			<div className="home-container row d-flex flex-xl-row-reverse ps-4 pt-0 pb-3">
				<div id="home-content" className="pt-5">
					...
					<h1 className="mb-0">
						Hi, I'm <span className="bold-name">Goutam Tiwari</span>
					</h1>
					...
					<div className="introduce">
						<p className="intro">
							I am a student currently pursuing a B.Tech in Computer Science & Engineering.
							<br />
							&#183; My short-term goal is to become a{" "}
							<strong>Software Engineer</strong>. <br />
							&#183; In the long run, I aspire to work as a{" "}
